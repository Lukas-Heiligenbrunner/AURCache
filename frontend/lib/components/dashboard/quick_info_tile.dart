...
class _QuickInfoTileState extends State<QuickInfoTile> {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              SizedBox(height: context.desktop ? 64 : 42, child: widget.icon),
            ],
          ),
        ],
      ),
  ...
  Widget _buildTrend() {
    ...
    if (widget.trendPercent! > .0) {
      return Row(
        children: [
          ...
          Text(
            ...
            style: TextStyle(color: Color(0xffA9FF0F)),
          ),
        ],
      );
      ...
      return Row(
        children: [
          Icon(Icons.keyboard_double_arrow_right, color: Color(0xff868686)),
          Text(
            "${widget.trendPercent?.abs().toStringAsFixed(1) ?? 42}%",
