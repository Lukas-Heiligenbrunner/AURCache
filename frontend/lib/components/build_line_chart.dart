...
class _BuildLineChartState extends State<BuildLineChart> {
  ...
  List<Color> gradientColors = [Colors.purple, Colors.deepPurpleAccent];
  ...
  Widget build(BuildContext context) {
    return AspectRatio(aspectRatio: 2, child: LineChart(mainData()));
  }
  ...
  Widget bottomTitleWidgets(double value, TitleMeta meta) {
    ...
    if (ivalue % 2 == 0 || value % 1 != 0) {
      ...
      final text = Text(months[(now.month + ivalue) % 12], style: style);
