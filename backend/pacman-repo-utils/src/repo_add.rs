...
builddate = 1762994719
packager = Unknown Packager <blub@gmail.com>
size = 7848790
arch = x86_64
license = MIT
conflict = dtop
...
depend = gcc-libs";
        ...
        let pkginfo = PackageInfoV2::from_str(pkginfo_str).unwrap();


        assert_eq!(pkginfo.to_string(), pkginfo_str);
    }
}